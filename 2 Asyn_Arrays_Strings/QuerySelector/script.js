...
document.getElementById('highlightAllBoxes').addEventListener('click', function() {
...
document.getElementById('highlightAllBoxesQuery').addEventListener('click', function() {
    // Get all elements with the class 'box'
    const boxesQS = document.querySelectorAll('.box');// nodeList
    boxesQS.forEach(box => {
